...
def error_function(radii_paths, positions_paths, velocities_paths):
    return sum((
        integrate_surfaces(rp, pp, vp)
        for rp, pp, vp in zip(radii_paths, positions_paths, velocities_paths)
    ))
